  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className="flex items-center gap-1.5  p-2.5 rounded-full text-black  hover:bg-black/5 transition-all duration-200 focus:outline-none  justify-center cursor-pointer"
      >
